 ...
 */
public class LazyInitializingNotifierExecutor extends LazyInitializingThreadPoolExecutor {
    ...
    protected static final String DEFAULT_THREAD_PREFIX = "async-notifier-pool";
    ...
    protected ThreadPoolExecutor createThreadPool() {
        ...
        final AsyncNotificationExecutorConfig asyncConfig = this.config.getAsyncNotificationExecutor();
    ...
    protected void cleanup(final ThreadPoolExecutor pool) {
        ...
        try {
            final TypedPropertiesConfig props = this.config.getAsyncNotificationExecutor().getProperties();
